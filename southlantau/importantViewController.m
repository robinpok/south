...
- (void)viewDidLoad
{
    ...
    NSString *endpoint;
    endpoint = [NSString stringWithFormat:@"http://pax-port.com//southlantau/important/getdata.php"];
    ...
    NSURLSessionDataTask *task = [session dataTaskWithRequest:request
                                  ...
                                  ^(NSData *data, NSURLResponse *response, NSError *error) {
                                      ...
                                      dispatch_async(dispatch_get_main_queue(), ^{
                                          ...
                                          [self.textScroll setText:(NSString*)[tmp objectForKey:@"text"]];
                                          //[self.textScroll setTextAlignment:NSTextAlignmentCenter];
                                          self.textScroll.font = [UIFont fontWithName:@"Bariol" size:20];
                                      });
